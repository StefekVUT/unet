...
class MyAugmentation(object):
    ...
    def __init__(self, train_path="train", label_path="label", merge_path="merge", aug_merge_path="aug_merge",
        ...
        self.datagen = ImageDataGenerator(rotation_range=0.2, width_shift_range=0.05, height_shift_range=0.05,
    ...
    def doaugmentate(self, img, save_to_dir, save_prefix, batch_size=1, save_format='tif', imgnum=30):
        ...
        i = 0
        for batch in datagen.flow(img, batch_size=batch_size, save_to_dir=save_to_dir, save_prefix=save_prefix,
