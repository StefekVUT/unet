...
class DataProcess(object):
    ...
    def load_train_data(self):
        ...
        print('-'*30)
        imgs_train = np.load(self.npy_path+"/imgs_train_rzd5000.npy")
        imgs_mask_train = np.load(self.npy_path+"/imgs_mask_rzd5000.npy")
    ...
    def load_test_data(self):
        ...
        print('-'*30)
        imgs_test = np.load(self.npy_path+"/imgs_6_test.npy")
